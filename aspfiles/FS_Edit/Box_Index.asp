...
%>
<div align="center">
<b><font size="4">File Index (Boxes)</font></b><br><br>
		<table border="0" cellpadding="0" cellspacing="0" width="80%" id="table1">
			<tr>
				...
				<td align="right"><a href="Box_Index.asp?X=999">Clear Location</a></td>
			</tr>
		</table>
<br>
<table width="80%">
...
End If%>
<%I=I+1%>
<td style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" align="center"><a href="Box_index.asp?X=<%=X%>&Location=<%=rstemp(0)%>"><%=rstemp(0)%></a>
(<%=count(0)%>)
&nbsp;</td>
