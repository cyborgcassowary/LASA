...
set rstemp=conntemp.execute("Select UserName,Department,Category,Days,A_Hours,Total_Cost,ID,CEU_Credit from tbl_users order by Department,Username,Category ASC;")
%>
<%do until rstemp.eof %>
...
<%If rstemp(4) <> "" then CATHours=CATHours+Int(rstemp(4))%>
<%CATCost=CATCost+Int(CourseCost)%>
		<tr>
			...
			<td style="text-align: center; border-left-width:1px; border-right-width:1px; border-top-style:solid; border-top-width:1px; border-bottom-width:1px" colspan="2">&nbsp;</td>
...
<%If rstemp(4) <> "" then TotalHours=TotalHours+Int(rstemp(4))%>
...
%>
		<tr>
			<td style="border-left-width: 1px; border-right-width: 1px; border-top-style: solid; border-top-width: 1px; border-bottom-width: 1px">&nbsp;</td>
			<td style="border-left-width: 1px; border-right-width: 1px; border-top-style: solid; border-top-width: 1px; border-bottom-width: 1px" colspan="2">&nbsp;</td>
