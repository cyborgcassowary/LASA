...
<%HomeState="PA"%>
<div align="center">
<b><font size="3">Add New Developer</font></b><hr width="80%">
...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form method="POST" action="D_Add.asp" name="FrontPage_Form1" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" webbot-action="--WEBBOT-SELF--">
	<table border="0" cellpadding="0" cellspacing="0" id="table1">
		<tr>
			<td style="text-align: right"><b>Name</b></td>
			<td colspan="3">
			<input type="text" name="D_Name" size="51"></td>
		</tr>
		<tr>
			<td style="text-align: right"><b>Address</b></td>
			<td colspan="3"><input type="text" name="D_Street" size="51"></td>
		</tr>
		<tr>
			<td style="text-align: right"><b>City, State, Zip</b></td>
			<td><input type="text" name="D_City" size="20"></td>
...
%>
			...
			<td>
			<!--webbot bot="Validation" s-display-name="Zip Code" s-data-type="Integer" s-number-separators="x" i-maximum-length="5" --><input type="text" name="D_Zip" size="5" maxlength="5"></td>
		</tr>
		<tr>
			<td style="text-align: right"><b>Phone Number</b></td>
			<td colspan="3">
			<!--webbot bot="Validation" s-display-name="Phone Number" s-data-type="String" b-allow-digits="TRUE" s-allow-other-chars="()-" --><input type="text" name="D_Number" size="20"></td>
		</tr>
		<tr>
			<td style="text-align: right"><b>Contact Person</b></td>
			<td colspan="3"><input type="text" name="D_Contact" size="51"></td>
		</tr>
		<tr>
			<td>
...
conn.open "DSN=PDM;"%>
<%RS = Conn.Execute("Insert Into tbl_Developer (D_Name,D_Street,D_City,D_State,D_Zip,D_Number,D_Contact) Values ('" & D_Name & "','" & D_Street & "','" & D_City & "','" & D_State & "','" & D_Zip & "','" & D_Number & "','" & D_Contact & "')")%>
<%
set RS=nothing
conn.close
Set conn=nothing
%>
<p align="center"><b>Developer has been added to the database.</b></p>
