...
<%Winder=Request.QueryString("Winder")%>
<%If Request.form("B1")="Submit" then InsertData%>
<%If Request.form("B1")="Cancel" then Cancel%>
<div align="center">
<form method="POST" action="Assign_Edit.asp" webbot-action="--WEBBOT-SELF--">
...
<p align="center"><b>Assignment has been Updated.</b></p>
<form method="POST" action="Assign_Edit.asp" name="Update" target="ibody">
        <input type="hidden" name="ID" Value="<%=ID%>">
        </form>
