...
<div align="center">
<b><font size="3">Engineer Index</font></b><hr width="80%">
...
set rstemp=conntemp.execute("Select * from tbl_Engineer order by E_Name ASC;")
%>
<%do until rstemp.eof %>
<%X=X+1%>
<%If X/2 = Int(X/2) then bgcolor="#C0C0C0" else bgcolor=""%>
		<tr bgcolor="<%=bgcolor%>">
			<td><a href="E_Edit.asp?ID=<%=rstemp(0)%>"><b><%=rstemp(1)%></b></a></td>
